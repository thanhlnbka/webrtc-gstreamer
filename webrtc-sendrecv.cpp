...
{
  cleanup_and_quit_loop ("Data channel error", AppState::APP_STATE_UNKNOWN);
}
...
{
  cleanup_and_quit_loop ("Data channel closed", AppState::APP_STATE_UNKNOWN);
}
    ...
    gpointer user_data G_GNUC_UNUSED)
{
  ...
  cleanup_and_quit_loop ("Server connection closed", AppState::APP_STATE_UNKNOWN);
}
    ...
    GBytes * message, gpointer user_data)
{
  ...
  if (g_strcmp0 (text, "HELLO") == 0) {
    ...
    cleanup_and_quit_loop (text, AppState::APP_STATE_UNKNOWN);
